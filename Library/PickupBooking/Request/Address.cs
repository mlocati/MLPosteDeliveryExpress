...
namespace MLPosteDeliveryExpress.PickupBooking.Request
{
    public class Address
    {
        ...
        [JsonPropertyName("closingTimeFrom")]
        [JsonConverter(typeof(TimeHHMMSS))]
        public TimeOnly? ClosingTimeFrom { get; set; } = null;

        [JsonPropertyName("closingTimeTo")]
        [JsonConverter(typeof(TimeHHMMSS))]
        public TimeOnly? ClosingTimeTo { get; set; } = null;
    }
}