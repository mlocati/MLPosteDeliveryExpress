...
namespace MLPosteDeliveryExpress.Waybill.Services
{
    ...
    /// </summary>
    public class SameDay2 : DeliveryDateTimeInterval<SameDay2>, IService
    {
        public string Code => "APT000998";
        public string Name => "Same_Day_2";
        ...
        public SameDay2(TimeOnly rangeFrom, TimeOnly rangeTo, DateOnly date)
            : base(rangeFrom, rangeTo, date)
        {
        }

        public static SameDay2 Unserialize(ref Utf8JsonReader reader, JsonSerializerOptions options)
        {
            var parameters = UnserializeValue(ref reader, options);
            return new(parameters.RangeFrom, parameters.RangeTo, parameters.Date);
        }

        public override bool Equals(SameDay2 other)
        {
