...
namespace MLPosteDeliveryExpress.Waybill.Services
{
    ...
    /// </summary>
    public class SameDay60 : DeliveryDateTimeInterval<SameDay60>, IService
    {
        public string Code => "APT001000";
        public string Name => "Same_Day_60";
        ...
        public SameDay60(TimeOnly rangeFrom, TimeOnly rangeTo, DateOnly date)
            : base(rangeFrom, rangeTo, date)
        {
        }

        public static SameDay60 Unserialize(ref Utf8JsonReader reader, JsonSerializerOptions options)
        {
            var parameters = UnserializeValue(ref reader, options);
            return new(parameters.RangeFrom, parameters.RangeTo, parameters.Date);
        }

        public override bool Equals(SameDay60 other)
        {
